...
= 1.5.5 - 21-08-2026 =
* Fixed: issue related to addons not showing in mobile application
* Fixed: issue related to checkout when multiple same addons present
* Added: extensions settings page in the admin menu
